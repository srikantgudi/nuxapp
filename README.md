# NuxtJS (Vue-3) + Drogon (C++ framework) API integrated together

## I was curious about creating an API in some language and integrating the same in a front-end app
